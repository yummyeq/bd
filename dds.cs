...
:root {
	...
	--successcolor: 			199, 158, 239;
	--warningcolor: 			167, 90, 245;
	--dangercolor: 				152, 51, 255;
}
...
.visual-refresh .theme-amoled:not(.custom-user-profile-theme) {
	...
	--bg-mod-faint: rgba(var(--transparencycolor_v), .3);
	--bg-mod-subtle: rgba(var(--transparencycolor_v), .4);
	--bg-mod-normal: rgba(var(--transparencycolor_v), .46);
	--bg-mod-strong: rgba(var(--transparencycolor_v), .54);
	--bg-base-primary: rgba(var(--transparencycolor_v), .2);
	--bg-base-secondary: rgba(var(--transparencycolor_v), .3);
	--bg-base-tertiary: rgba(var(--transparencycolor_v), .4);
	--bg-surface-raised: rgba(var(--transparencycolor_v), .2);
	...
	--deprecated-text-input-bg: rgba(var(--transparencycolor_v), .1);
	--deprecated-text-input-border: rgba(var(--transparencycolor_v), .1);
	--deprecated-text-input-border-hover: rgba(var(--transparencycolor_v), .3);
}
...
#app-mount .folder__48112 {								/* folder				iconwrap							*/
	background-color: rgba(var(--transparencycolor_v), .2);
}
#app-mount .folder__48112.hover__48112 {
	background-color: rgba(var(--transparencycolor_v), .4);
}
#app-mount .expandedFolderBackground__48112 {						/* folder				background							*/
	background-color: rgba(var(--transparencycolor_v), .2);
	transition: border-radius 3s ease, background-color 1s ease;
}
#app-mount .expandedFolderBackground__48112.hover__48112 {
	background-color: rgba(var(--transparencycolor_v), .4);
}
...
.wrapper__260e1 {									/* voicechat				limit								*/
...
.panels_c48ade > *::after {
	background-color: rgba(var(--transparencycolor_v), calc(var(--guildchanneltransparency_v) * 2.5 + var(--transparencyalpha_v)));
	backdrop-filter: blur(var(--backgroundblur_v));
}
.panels_c48ade::before,
.panels_c48ade::after {
...
.panels_c48ade > *:first-child::before,
.panels_c48ade > *:first-child::after,
.panels_c48ade > *:first-child:empty + *::before,
.panels_c48ade > *:first-child:empty + *::after {
	border-top-left-radius: var(--radius-sm);
	border-top-right-radius: var(--radius-sm);
}
.panels_c48ade > *:last-child::before,
.panels_c48ade > *:last-child::after {
	border-bottom-left-radius: var(--radius-sm);
	border-bottom-right-radius: var(--radius-sm);
}

.panels_c48ade > *,									/* account/voice			inner								*/
.panels_c48ade .wrapper_e131a9 > * {							/* account/voice			inner								*/
	background: none;
	border: none;
}
.panels_c48ade > *:not(:empty) ~ *:not(:empty) {
...
#app-mount .avatarWrapper__37e49::after {
	content: "";
	position: absolute;
	top: 0;
	right: 0;
...
#app-mount .avatarWrapper__37e49:hover::after {
...
.searchBar__97492 {									/* header				searchbar							*/
	background-color: rgba(var(--transparencycolor_v), .3);
}
...
.markup__75297 pre {									/* messageelement			pre								*/
	background-color: rgba(var(--transparencycolor_v), .4);
...
#app-mount .wrapper_cb9592 {								/* call					root								*/
	background: rgba(var(--transparencycolor_v), 0);
	color: var(--header-primary);
}
#app-mount .buttonSection__1405b {
	background: rgba(var(--transparencycolor_v), 0.3);
}
...
#app-mount .side_b3f026 .themed_b3f026.item_b3f026:active:not(.disabled_b3f026),	/* sideitems												*/
#app-mount .topPill_b3f026 .themed_b3f026.item_b3f026:active:not(.disabled_b3f026),	/* tabitems												*/
#app-mount .side_b3f026 .themed_b3f026.item_b3f026:hover:not(.disabled_b3f026),		/* sideitems												*/
#app-mount .topPill_b3f026 .themed_b3f026.item_b3f026:hover:not(.disabled_b3f026) {	/* tabitems												*/
	background-color: rgba(var(--transparencycolor_v), .2);
}
#app-mount .side_b3f026 .themed_b3f026.selected_b3f026.item_b3f026,
#app-mount .topPill_b3f026 .themed_b3f026.selected_b3f026.item_b3f026,
#app-mount .side_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:active,
#app-mount .topPill_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:active,
#app-mount .side_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:hover,
#app-mount .topPill_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:hover {
	background-color: rgb(var(--accentcolor_v));
	color: #fff;
	text-shadow: 1px 1px var(--textshadow_v);
}
#app-mount .side_b3f026 .themed_b3f026.selected_b3f026.item_b3f026 div[style*="color: var(--text-muted)"],
#app-mount .topPill_b3f026 .themed_b3f026.selected_b3f026.item_b3f026 div[style*="color: var(--text-muted)"],
#app-mount .side_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:active div[style*="color: var(--text-muted)"],
#app-mount .topPill_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:active div[style*="color: var(--text-muted)"],
#app-mount .side_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:hover div[style*="color: var(--text-muted)"],
#app-mount .topPill_b3f026 .themed_b3f026.selected_b3f026.item_b3f026:hover div[style*="color: var(--text-muted)"] {
	color: #ddd !important;
}
.sidebar__23e6b:has(.socialLinks__7df54) .side_b3f026 .item_b3f026::after {
	filter: drop-shadow(1px 1px var(--textshadow_v));
}
...
#app-mount .button_e18686 {								/* settingscard				removebutton							*/
	background-color: rgba(var(--transparencycolor_v), .3);
...
.preview__3e443 {									/* appearance				preview								*/
	background-color: rgba(var(--transparencycolor_v), .2);
...
#app-mount .colorPickerSwatch__459fb.noColor_e34214 .colorPickerDropperFg__0d1bc {
	fill: var(--header-primary);
}
...
.layer_da8173:nth-child(1) {
	z-index: 1012;
}
.layer_da8173:nth-child(2) {
	z-index: 1013;
}
.layer_da8173:nth-child(3) {
	z-index: 1014;
}
.layer_da8173:nth-child(4) {
	z-index: 1015;
}
.layer_da8173:nth-child(5) {
	z-index: 1016;
}
.layer_da8173:nth-child(6) {
	z-index: 1017;
}
.layer_da8173:nth-child(7) {
	z-index: 1018;
}
.layer_da8173:nth-child(8) {
	z-index: 1019;
}
.layer_da8173:nth-child(9) {
	z-index: 1020;
}
.layer_da8173 ~ .layer_bc663c,
.layer_da8173 ~ .backdrop__1a911.withLayer__29ace {
	z-index: 1021;
}
...
.outer_c0bea0.custom-user-profile-theme .inner_c0bea0::after {
	content: "";
	position: absolute;
	display: block;
...
.lookFilled__201d5.hoverBrand__252e8.hasHover_dfa15e:hover,
.lookFilled__201d5.hoverBrandNew__5984d.hasHover_dfa15e:hover,
.lookFilled__201d5.colorBrand__201d5:not(.buttonColor_e131a9):not([style*="background-color"]),
.lookFilled__201d5.colorBrandNew__8872c:not(.buttonColor_e131a9):not([style*="background-color"]) {
	text-shadow: 1px 1px var(--textshadow_v);
}
.lookFilled__201d5.hoverBrand__252e8.hasHover_dfa15e:hover svg,
.lookFilled__201d5.hoverBrandNew__5984d.hasHover_dfa15e:hover svg,
.lookFilled__201d5.colorBrand__201d5:not(.buttonColor_e131a9):not([style*="background-color"]) svg,
.lookFilled__201d5.colorBrandNew__8872c:not(.buttonColor_e131a9):not([style*="background-color"]) svg {
	filter: drop-shadow(1px 1px var(--textshadow_v));
}
...
input.input__0f084 {									/* valueinput				bordered							*/
	background-color: rgba(var(--transparencycolor_v), .1);
}
input.input__0f084:hover:not(:focus) {
	border-color: rgb(var(--transparencycolor_v));
}
...
.container__87bf1 {									/* checkboxswitch											*/
	background-color: rgba(var(--transparencycolor_v), .3) !important;
}
.container__87bf1 rect[fill] {
...
.bar_c38106 .title_c38106 {
	position: static;
	top: -10px !important;
	left: calc(-20px - (50% - calc(var(--custom-guild-list-width) + var(--space-8)))) !important;
	background-image: unset !important;
	margin-left: calc(50% - calc(var(--custom-guild-list-width) + var(--space-8)));
}
html:only-child > head + body div.bar_c38106 > div.title_c38106::before {
	content: "" !important;
	background: rgba(var(--textbrightest_v), .4) !important;
...
html:only-child > head + body div.app_a3002d > div.app__160d8 > div.layers__960e4.layers__160d8 > div.layer__960e4.baseLayer__960e4 + div.layer__960e4 > div.standardSidebarView__23e6b::after {
